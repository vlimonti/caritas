                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td style="width=10px;">
                                ...
                                <a href="{{ route('categories.show', $category->id) }}" class="btn btn-warning" title="Ver"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('categories.musics', $category->id) }}" class="btn btn-dark" title="Músicas"><i class="fas fa-music"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
